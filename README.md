...
Payload2026/
├── src/
│   ├── generate_fairing_dataset.py  # Abaqus Python Script for Dataset Generation
│   └── preprocess_data.py           # (Planned) FEM Result to Graph Converter
├── references/                      # External Repositories (MeshPhysicsGNN-NeuralOps, etc.)
