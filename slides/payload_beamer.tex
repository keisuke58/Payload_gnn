...
\begin{itemize}
  ...
  \item \textbf{GW dataset expansion} — re-run 100 healthy Abaqus simulations with 99-sensor layout
        $\Rightarrow$ consistent 197-sample dataset (100H\,+\,97D); enables proper L3 PINN evaluation
  \item \textbf{Level-3 PINN} — wave-phase consistency $\mathcal{L}_\text{disp}$ active in v2;
        regularisation effect evaluable once $\gtrsim$50 defect samples available
