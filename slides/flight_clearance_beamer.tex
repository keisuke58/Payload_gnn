...
\begin{itemize}\footnotesize
  \item type/location posterior: long-term tags (13 damage states) + 5-class FEM localisation, \emph{calibrated} (ECE-reported)
  \item phase-field: anisotropic AT2 with interface bands + Carrara-2020 fatigue
\end{itemize}
\end{frame}
