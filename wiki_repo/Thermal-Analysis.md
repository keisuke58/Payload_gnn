...
- [x] CTE修正: CFRP α₁₁=-0.3e-6, α₂₂=28e-6 (5ファイル修正, 2026-03-03)
- [x] Abaqus実行: 外板 100-221°C (z依存), 内板 20°C, コア 70°C
- [x] CSV出力: temp=100-221°C (1026 unique), thermal_smises≠smises (diff=4.06 MPa)
- [x] 熱応力発生: SMISES +19% (mean 24.6→29.3 MPa)、thermal_smises が独立特徴量化
- [ ] GNN入力: `data.x.shape` = (N, 34) で温度・熱応力次元が有情報化
