...
| 種類 | 界面 | 発生要因 | 本プロジェクト |
|------|------|----------|-----------------|
| **製造時接着不良** | 外スキン-コア | OoA 接着の不完全固化、異物混入 | **対象** (debonding) |
| **製造時接着不良** | 内スキン-コア | 同上 | **対象** (inner_debond) |
| **異物混入** | コア内 | FOD | **対象** (fod) |
| **衝撃損傷** | 両面 | 取扱い、異物衝突 | **対象** (impact) |
| **積層内層間剥離** | 積層内 | デラミネーション | **対象** (delamination) |
| **熱応力による進展** | 外スキン-コア | CTE 不整合 | **対象** (thermal_progression) |
| **音響疲労** | 外スキン-コア | 打ち上げ 147–148 dB | **対象** (acoustic_fatigue) |

**F8 事故の示唆**: 製造検査で PSS 4個全てに想定を超える剥離を確認。製造時接着不良が有力要因。

詳細は [Extended-Defect-Types](Extended-Defect-Types) を参照。
